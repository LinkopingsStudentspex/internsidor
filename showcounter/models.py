...
class Performance(models.Model):
    ...
    start_time = models.TimeField(verbose_name='starttid', null=True, blank=True)
    notes = models.TextField(verbose_name='övrigt', blank=True, help_text="Allmäna övriga anmärkningar om föreställningen")
