...
class Asset(models.Model):
    number = models.IntegerField(_("Number"), unique=True, validators=[MinValueValidator(1),])

    model = models.ForeignKey(AssetModel, models.PROTECT, verbose_name=_("Model"), related_name='assets')
    ...
    standard_location = models.CharField(_("Standard location"), max_length=100, blank=True)
