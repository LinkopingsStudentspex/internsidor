# Generated by Django 3.0.6 on 2020-06-08 18:38
    ...
    operations = [
            ...
            fields=[
                (
                    ...
                    models.PositiveIntegerField(
                        default=batadasen.models.get_current_assoc_end_year,
                        primary_key=True,
                        serialize=False,
                        validators=[batadasen.models.validate_association_year],
                        verbose_name="slutår",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "member_number",
                    models.PositiveIntegerField(
                        default=batadasen.models.get_next_member_number,
                        primary_key=True,
                        serialize=False,
                        verbose_name="medlemsnummer",
                    ),
                ),
                ...
                (
                    "spex_name",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="spexnamn"
                    ),
                ),
                (
                    "last_name",
                    models.CharField(max_length=50, verbose_name="efternamn"),
                ),
                (
                    "maiden_name",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="flicknamn"
                    ),
                ),
                (
                    "street_address",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="gatuadress"
                    ),
                ),
                (
                    "postal_locality",
                    models.CharField(blank=True, max_length=50, verbose_name="postort"),
                ),
                (
                    "postal_code",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="postnummer"
                    ),
                ),
                (
                    "country",
                    models.CharField(blank=True, max_length=50, verbose_name="land"),
                ),
                (
                    "phone_home",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="hemtelefon"
                    ),
                ),
                (
                    "phone_work",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="jobbtelefon"
                    ),
                ),
                (
                    "phone_mobile",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="mobiltelefon"
                    ),
                ),
                (
                    "phone_extra",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="extra telefon"
                    ),
                ),
                (
                    "domestic_partner",
                    models.IntegerField(blank=True, null=True, verbose_name="sambo"),
                ),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    ...
                    models.EmailField(
                        ...
                        max_length=254,
                        verbose_name="adresslistmail",
                    ),
                ),
                (
                    "home_page",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="hemsida"
                    ),
                ),
                (
                    "wants_spexpressen",
                    models.BooleanField(
                        default=False, verbose_name="vill få spexpressen"
                    ),
                ),
                (
                    "wants_spexinfo",
                    models.BooleanField(
                        default=True, verbose_name="vill få spexinfo-mail"
                    ),
                ),
                (
                    "wants_trams",
                    models.BooleanField(
                        default=False, verbose_name="vill få trams-mail"
                    ),
                ),
                (
                    "wants_blandat",
                    models.BooleanField(
                        default=True, verbose_name="vill få blandat-mail"
                    ),
                ),
                (
                    "lifetime_member",
                    models.BooleanField(default=False, verbose_name="livstidsmedlem"),
                ),
                (
                    "honorary_member",
                    models.BooleanField(default=False, verbose_name="hedersmedlem"),
                ),
                (
                    "hundred_club",
                    models.BooleanField(default=False, verbose_name="hundraklubben"),
                ),
                (
                    "deceased",
                    models.BooleanField(default=False, verbose_name="avliden"),
                ),
                (
                    "address_changed_date",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="adress ändrad"
                    ),
                ),
                (
                    "mail_changed_date",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="mail ändrad"
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, max_length=1000, null=True, verbose_name="övrigt"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_title",
                    models.CharField(max_length=100, verbose_name="huvudtitel"),
                ),
                (
                    "subtitle",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="undertitel"
                    ),
                ),
                (
                    "short_name",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="kort namn"
                    ),
                ),
                (
                    "year",
                    models.PositiveIntegerField(
                        validators=[batadasen.models.validate_production_year],
                        verbose_name="år",
                    ),
                ),
                (
                    "plot",
                    models.TextField(
                        blank=True, max_length=1000, verbose_name="handling"
                    ),
                ),
                ("closed", models.BooleanField(default=False, verbose_name="avslutad")),
                (
                    "regular",
                    models.BooleanField(default=True, verbose_name="ordinarie"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_alias",
                    models.CharField(max_length=20, verbose_name="mailalias"),
                ),
                ("priority", models.IntegerField(default=0, verbose_name="prioritet")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "valid_until",
                    models.DateTimeField(
                        default=batadasen.models.calculate_expiration_time,
                        verbose_name="giltig tills",
                    ),
                ),
                (
                    "token",
                    models.CharField(
                        default=batadasen.models.generate_activation_token,
                        max_length=50,
                        verbose_name="token",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="batadasen.ProductionGroupType",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="batadasen.AssociationGroupType",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "to_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="till och med datum"
                    ),
                ),
                (
                    "group",
