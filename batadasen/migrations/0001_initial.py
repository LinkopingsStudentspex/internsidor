...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('end_year', models.PositiveIntegerField(default=batadasen.models.get_current_assoc_end_year, primary_key=True, serialize=False, validators=[batadasen.models.validate_association_year], verbose_name='slutår')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='Hit kommer mail från spexets maillistor skickas.', max_length=254, null=True, unique=True, verbose_name='mail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group_type', models.ForeignKey(blank=True, help_text='lämna tomt om den här gruppen ska räknas som att vara med i en uppsättning utan att tillhöra en specifik grupp', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_instances', to='batadasen.ProductionGroupType', verbose_name='grupptyp')),
                ('production', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='batadasen.Production', verbose_name='uppsättning')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_association_groups', models.ManyToManyField(blank=True, help_text='Denna lista kommer skicka mail till dessa aktiva föreningsgrupper', related_name='email_lists', to='batadasen.AssociationGroupType', verbose_name='föreningsgrupper för aktivt verksamhetsår')),
                ...
                ('association_groups', models.ManyToManyField(blank=True, help_text='Denna lista kommer skicka mail till personer som var med i dessa föreningsgrupper ett visst år', related_name='email_lists', to='batadasen.AssociationGroup', verbose_name='föreningsgrupper från enskilda verksamhetsår')),
        ...
        migrations.AddField(
            ...
            name='group_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='batadasen.AssociationGroupType', verbose_name='grupptyp'),
        ),
        migrations.AddField(
            model_name='associationgroup',
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='batadasen.AssociationYear', verbose_name='verksamhetsår'),
        ),
        migrations.CreateModel(
            name='ProductionMembership',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='batadasen.ProductionGroup', verbose_name='Grupp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='batadasen.AssociationGroup', verbose_name='grupp')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='association_activities', to='batadasen.Person', verbose_name='person')),
