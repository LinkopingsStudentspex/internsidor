    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default="STD",
                help_text="För vanligt medlemskap, lägg till nytt medlemskap för varje år.För livstidsmedlemskap och hedersmedlemskap, lägg in det året de blev livstid- eller hedersmedlemmar.",
                max_length=3,
